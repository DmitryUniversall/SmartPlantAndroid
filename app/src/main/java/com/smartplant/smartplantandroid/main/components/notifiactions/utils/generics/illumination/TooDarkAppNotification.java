...
public class TooDarkAppNotification extends AbstractAppNotification {
    protected TooDarkAppNotification(
    ...
    protected String getDefaultTitle() {
        return this.context.getString(R.string.too_dark_default_title);
    }

    @NonNull
    @Override
    protected String getDefaultDescription() {
        return this.context.getString(R.string.too_dark_default_description);
    }
