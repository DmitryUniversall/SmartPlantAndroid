package com.smartplant.smartplantandroid.main.components.notifiactions.utils.generics.humidity;
...
public class HighHumidityAppNotification extends AbstractAppNotification {
    protected HighHumidityAppNotification(
